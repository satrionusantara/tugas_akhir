...
<html>
<head>
	<title>Laporan Pengeluaran Bulan {{$formattedBulan}}</title>
	<!-- Bootstrap CSS -->
...
<div style="margin-top:-30px; margin-bottom:-20px">
	...
	<p style="font-size:18px; font-family: 'Arial', sans-serif;font-weight: bold;text-align: center;"><u style="border-bottom: 2px solid #000;">LAPORAN DATA PENGELUARAN BULAN {{strtoupper($formattedBulan)}}</u></p>
