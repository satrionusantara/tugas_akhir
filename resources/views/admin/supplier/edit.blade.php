...
@section('content')
    <div class="min-height-200px">
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                <div class="pull-left">
                    <h2 class="text-primary h2"><i class="icon-copy dw dw-edit-1"></i> Edit Data Supplier</h2>
                </div>
            ...
            <form action="/admin/supplier/update/{{ $supplier->id }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" autofocus name="nama" required class="form-control"
                                value="{{ $supplier->nama }}" placeholder="Masukkan Nama supplier .....">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="no_hp" required class="form-control"
                                value="{{ $supplier->no_hp }}" placeholder="Masukkan No HP supplier .....">
                        </div>
                    </div>
                </div>
