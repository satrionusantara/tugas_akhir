		...
		{{-- <div class="pre-loader">
			<div class="pre-loader-box">
				<div class="loader-logo">
					<img src="{{url('assets-admin')}}/src/images/logo-ayam.png" alt="" />
				</div>
    ...
    <div class="sidebar-menu">
        <ul id="accordion-menu">
            ...
            @if(Auth::user()->level === '1')
				...
				{{-- data sales --}}
                {{-- <li>
                    <a href="/admin/sales" class="dropdown-toggle no-arrow @if ($activePage == 'sales') active @endif">
                        <span class="micon dw dw-id-card2"></span><span class="mtext">Data Sales</span>
                    </a>
                </li> --}}

                <li>
                    <a href="/admin/barang" class="dropdown-toggle no-arrow @if ($activePage == 'barang') active @endif">
                        <span class="micon dw dw-box-1"></span><span class="mtext">Data Barang</span>
                    </a>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="/admin/barang_masuk" class="@if ($activePage == 'barang_masuk') active @endif">Barang Masuk</a></li>
                ...
                <li>
                    <a href="/admin/pengeluaran" class="dropdown-toggle no-arrow @if ($activePage == 'pengeluaran') active @endif">
                        <span class="micon dw dw-wallet"></span><span class="mtext">Data Pengeluaran</span>
                    </a>
                </li>

                <li>
                    <a href="/admin/pemasukan" class="dropdown-toggle no-arrow @if ($activePage == 'pemasukan') active @endif">
                        <span class="micon dw dw-analytics-4"></span><span class="mtext">Data Pemasukan</span>
                    </a>
                </li>

                <!-- <li>
                    <a href="/admin/hutang" class="dropdown-toggle no-arrow @if ($activePage == 'hutang') active @endif">
                        <span class="micon dw dw-book-1"></span><span class="mtext">Data Hutang</span>
                    </a>
                </li>

                <li>
                    <a href="/admin/piutang" class="dropdown-toggle no-arrow @if ($activePage == 'piutang') active @endif">
                        <span class="micon dw dw-notepad-1"></span><span class="mtext">Data Piutang</span>
                    </a>
                </li> -->
                ...
                {{-- <li>
                    <a href="/admin/asset" class="dropdown-toggle no-arrow @if ($activePage == 'asset') active @endif">
                        <span class="micon dw dw-book2"></span><span class="mtext">Data Asset</span>
                    </a>
                </li> --}}
            @endif
            ...
            <!-- <li>
                <a href="/admin/diskon" class="dropdown-toggle no-arrow @if ($activePage == 'diskon') active @endif">
                    <span class="micon dw dw-money"></span><span class="mtext">Data Diskon</span>
                </a>
            </li>

            <li>
                <a href="/admin/member" class="dropdown-toggle no-arrow @if ($activePage == 'member') active @endif">
                    <span class="micon dw dw-id-card2"></span><span class="mtext">Data Member</span>
                </a>
            </li>

            <li>
                <a href="/admin/costumer" class="dropdown-toggle no-arrow @if ($activePage == 'costumer') active @endif">
                    <span class="micon dw dw-id-card2"></span><span class="mtext">Data Costumer</span>
                </a>
            </li> -->
        </ul>
    </div>
		...
		<div class="main-container">
			<div class="pd-ltr-20">
				...
				<div class="footer-wrap pd-20 mb-20 card-box">
					Toko Syukurilah - Copyright © {{date('Y')}}
